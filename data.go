...
type ChargeWithStoredCard struct {
	...
	CVV2 uint `json:"cvv2,omitempty"`

	// Device identifier generated by the fraud prevention tool
	DeviceSessionID string `json:"device_session_id,omitemtpy"`
...
type PaymentPlan struct {
	// Number of monthly installments for the operation
	Payments uint `json:"payments"`
}
